...
const PartnerLogin = ({ toggleForm, toggleUserType }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100 p-4">
      <div className="bg-white rounded-2xl shadow-xl flex flex-col md:flex-row w-full max-w-4xl">
        ...
        <div className="md:w-1/2 bg-gradient-to-br from-orange-500 to-red-500 rounded-l-2xl hidden md:flex flex-col justify-center items-center p-8 text-white">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4">Food Partners</h2>
            <p className="mb-6">Showcase your culinary creations to food enthusiasts everywhere.</p>
            <div className="bg-white/20 p-4 rounded-xl backdrop-blur-sm">
              <p className="text-sm">New to our partner program?</p>
              <button
        ...
        <div className="md:w-1/2 p-8 md:p-12">
          ...
          <div className="mt-6">
            <p className="text-center text-sm text-gray-600">
              ...
              <button onClick={() => navigate("/partner/register")} className="font-medium text-orange-600 hover:text-orange-800">
                Sign up
              </button>
            </p>
          </div>
